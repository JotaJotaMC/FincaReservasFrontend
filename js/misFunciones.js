function traerInformacionCategorias() {
    $.ajax({
        url: "http://129.151.119.182:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacionCategorias() {
    ...
    $.ajax({
        ...
        url: "http://129.151.119.182:8080/api/Category/save",
...
function traerInformacionFarm() {
    $.ajax({
        url: "http://129.151.119.182:8080/api/Farm/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function guardarInformacionFarm() {
    ...
    $.ajax({
        ...
        url: "http://129.151.119.182:8080/api/Farm/save",
...
function traerInformacionClientes() {
    $.ajax({
        url: "http://129.151.119.182:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function guardarInformacionClientes() {
    ...
    $.ajax({
        ...
        url: "http://129.151.119.182:8080/api/Client/save",
...
function traerInformacionMensaje() {
    $.ajax({
        url: "http://129.151.119.182:8080/api/Message/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function guardarInformacionMensaje() {
    ...
    $.ajax({
        ...
        url: "http://129.151.119.182:8080/api/Message/save",
  ...
  function traerInformacionReservacion() {
    $.ajax({
        url: "http://129.151.119.182:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
            console.log(respuesta);
...
function guardarInformacionReservacion() {
    ...
    $.ajax({
        ...
        url: "http://129.151.119.182:8080/api/Reservation/save",
